class Best extends egret.DisplayObjectContainer{
	...
	public static INIT_BEST = egret.localStorage.getItem('best')
	public static BEST_WIDTH = RoundRect.getWidthByContent(Best.INIT_BEST)
